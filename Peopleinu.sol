...
contract PeopleInu is ERC20, Ownable {
    ...
    constructor () ERC20("People Inu", "People Inu") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x52dFF7528C660004BDa1D5C31a92498BD3aB74df;
        ...
        _mint(owner(), 8000_000_000 * (10 ** decimals()));
